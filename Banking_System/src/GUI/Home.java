...
public class Home extends JFrame {
    ...
    private void createButtons() {
        JButton btnDeposit = createButton("Deposit", e -> openWindow(Deposit.class));
        btnDeposit.setBounds(498, 174, 204, 54);
        getContentPane().add(btnDeposit);

        JButton btnWithdraw = createButton("Withdraw", e -> openWindow(Withdraw.class));
        btnWithdraw.setBounds(498, 239, 204, 54);
        getContentPane().add(btnWithdraw);

        JButton btnCheckBalance = createButton("Check Balance", e -> openWindow(Account_Statement.class));
